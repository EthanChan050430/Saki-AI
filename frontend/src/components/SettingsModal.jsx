...
import { X, Cpu, Server, Terminal, Shield, ExternalLink, RefreshCw, CheckCircle2, Image, ChevronDown, UserCircle, Palette, Plus, Globe, Bot, Search, Volume2, Mic, Music2, Trash2 } from 'lucide-react';
          ...
          <section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              {[
                ...
                { id: 'lmstudio', name: 'LMStudio', sub: t('local_model') },
            ...
            {config.provider !== 'ollama' && config.provider !== 'copilot' && config.provider !== 'lmstudio' && (
